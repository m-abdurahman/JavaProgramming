...
public class ArrayEquals {
    public static void main(String[] args) {
        ...
        System.out.println(nums1 == nums2);   //doesn't check for values; check to point the same object in memory

        if (Arrays.equals(nums1, nums2)) {
            System.out.println("nums1 & nums2 match");
        }else{
            System.out.println("nums1 & nums2 don't match");
        }

        if (Arrays.equals(nums2, nums3)){
            System.out.println("nums2 & nums3 match");
        }else{
            System.out.println("nums2 & nums3 don't match");
        }
