...
public class OperatorPrecedence {
    public static void main(String[] args){
        ...
        System.out.println(2 * 3 / 3); //2 left to right
        System.out.println(20 / (2 * 2)); // --> 20/4 =5
        //System.out.println(10 / 0); -> can NOT divide by 0. ERROR

        System.out.println(2 + 5 * 3); //17
        System.out.println((2 + 5) *3); //21

        System.out.println(10 / 3); // only 3 not 3.333, java doesn't print the decimals
